...
class __TwigTemplate_69941a013e4d692e9da76ea7a1a2f90bebc0a7a9e8a6223564be8395e157422b extends Twig_Template
{
    ...
    Sfjs = (function() {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute($_request_, "basePath", array()), "js"), "html", null, true);
            echo "')) {
                            path = url.substr(";
            // line 209
            if (isset($context["request"])) { $_request_ = $context["request"]; } else { $_request_ = null; }
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute($_request_, "basePath", array())), "html", null, true);
            echo ");
                        }
                    }
            ...
            // line 212
            if (isset($context["request"])) { $_request_ = $context["request"]; } else { $_request_ = null; }
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, ($this->getAttribute($_request_, "schemeAndHttpHost", array()) . $this->getAttribute($_request_, "basePath", array())), "js"), "html", null, true);
            echo "')) {
                        path = url.substr(";
            // line 213
            if (isset($context["request"])) { $_request_ = $context["request"]; } else { $_request_ = null; }
            echo twig_escape_filter($this->env, twig_length_filter($this->env, ($this->getAttribute($_request_, "schemeAndHttpHost", array()) . $this->getAttribute($_request_, "basePath", array()))), "html", null, true);
            echo ");
                    }

                    if (path.substr(0, 1) === '/' && !path.match(new RegExp(";
            // line 216
            if (isset($context["excluded_ajax_paths"])) { $_excluded_ajax_paths_ = $context["excluded_ajax_paths"]; } else { $_excluded_ajax_paths_ = null; }
            echo twig_jsonencode_filter($_excluded_ajax_paths_);
            echo "))) {
                        var stackElement = {
                            loading: true,
                            error: false,
...
";
    ...
    {
        return array (  289 => 246,  255 => 216,  248 => 213,  243 => 212,  236 => 209,  231 => 208,  220 => 199,  218 => 198,  19 => 1,);
    }
}
/* <script>/*<![CDATA[*//* */
/*     Sfjs = (function() {*/
