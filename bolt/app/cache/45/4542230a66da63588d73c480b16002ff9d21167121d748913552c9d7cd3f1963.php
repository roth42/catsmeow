...
class __TwigTemplate_577f4c4e17c44c269ffe8e29206718902524f69796e2e0a9848332ffc58f84aa extends Twig_Template
{
...
";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_nav_, "submenu", array(0 => "fa:cogs", 1 => $this->env->getExtension('Bolt')->trans("Configuration"), 2 => $_sub_, 3 => ($_page_nav_ == "Settings/Configuration")), "method"), "html", null, true);
        echo "
";
    }
