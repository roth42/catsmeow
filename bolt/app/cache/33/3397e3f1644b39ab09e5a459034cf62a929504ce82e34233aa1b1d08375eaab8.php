...
class __TwigTemplate_333a8d4a63fcdc755a78748b8ddbd202a16a6e39ef380d44d2d593ff6318cf77 extends Twig_Template
{
    ...
    {
        // line 5
        return $this->loadTemplate((($this->getAttribute($this->getContext($context, "news", true), "title", array(), "any", true, true)) ? ("_base/_panel.twig") : ("_base/_nothing.twig")), "components/panel-news.twig", 5);
    }
    ...
    public function block_panel_alert($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($_news_, "type", array()) == "alert")) {
            // line 11
    ...
    public function block_panel_body($context, array $blocks = array())
    {
        ...
        echo "    ";
        if (isset($context["news"])) { $_news_ = $context["news"]; } else { $_news_ = null; }
        echo $this->getAttribute($_news_, "teaser", array());
        echo "
";
    }
    ...
    {
        return array (  70 => 22,  67 => 21,  60 => 19,  54 => 17,  48 => 13,  44 => 11,  40 => 10,  37 => 9,  31 => 7,  22 => 5,);
    }
}
/* {##*/
